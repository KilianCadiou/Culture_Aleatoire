...
playlist_film = pd.read_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/films_a_jour.csv', index_col=0)
playlist_film_selection = playlist_film.copy()
playlist_musique = pd.read_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/playlist_a_jour.csv', index_col=0)
playlist_musique_selection = playlist_musique.copy()
playlist_livre = pd.read_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/livres_a_jour.csv', index_col=0)
...
if action == 'Un Film':
    ...
    if resultat: 
        ...
        if acceptation: 
            ...
            playlist_film.to_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/films_a_jour.csv', index_col=0)
            playlist_film = pd.read_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/films_a_jour.csv', index_col=0)
...
if action == 'Une Musique':
    ...
    if resultat:
        ...
        if acceptation:
            ...
            playlist_musique.to_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/playlist_a_jour.csv', index_col=0)
            playlist_musique = pd.read_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/playlist_a_jour.csv', index_col=0)
...
if action == 'Un Livre':
    ...
    if resultat:
        ...
        if acceptation:
            ...
            playlist_livre.to_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/livres_a_jour.csv', index_col=0)
            playlist_livre = pd.read_csv('/Users/kilian/Google Drive/1 - PERSO/Github/BD_Culture_Aleatoire/livres_a_jour.csv', index_col=0)